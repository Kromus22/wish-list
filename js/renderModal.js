...
export const renderModal = ({ title, description, btnSubmit, submitHandler }) => {
  ...
  const modalIputLogin = createElement('input', {
  ...
  const modalIputPassword = createElement('input', {
    className: 'modal__input',
    type: 'password',
    name: 'password',
    placeholder: 'Пароль',
  ...
  modalLabelLogin.append(modalIputLogin);
  modalLabelPassword.append(modalIputPassword);
